...
/**
     ...
     * @return \EgoiClient\EgoiModel\CountryCollection|\EgoiClient\EgoiModel\Unauthorized|\EgoiClient\EgoiModel\Forbidden|\EgoiClient\EgoiModel\RequestTimeout|\EgoiClient\EgoiModel\UnprocessableEntity|\EgoiClient\EgoiModel\TooManyRequests|\EgoiClient\EgoiModel\InternalServerError|\EgoiClient\EgoiModel\ServiceUnavailable
     */
    public function getAllCountries($phone = null, string $contentType = self::contentTypes['getAllCountries'][0])
    {
        list($response) = $this->getAllCountriesWithHttpInfo($phone, $contentType);
        return $response;
    }
     ...
     * @throws \EgoiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EgoiClient\EgoiModel\CountryCollection|\EgoiClient\EgoiModel\Unauthorized|\EgoiClient\EgoiModel\Forbidden|\EgoiClient\EgoiModel\RequestTimeout|\EgoiClient\EgoiModel\UnprocessableEntity|\EgoiClient\EgoiModel\TooManyRequests|\EgoiClient\EgoiModel\InternalServerError|\EgoiClient\EgoiModel\ServiceUnavailable, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllCountriesWithHttpInfo($phone = null, string $contentType = self::contentTypes['getAllCountries'][0])
    {
        $request = $this->getAllCountriesRequest($phone, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\EgoiClient\EgoiModel\CountryCollection' === '\SplFileObject') {
                        ...
                        if ('\EgoiClient\EgoiModel\CountryCollection' !== 'string') {
     ...
     */
    public function getAllCountriesAsync($phone = null, string $contentType = self::contentTypes['getAllCountries'][0])
    {
        return $this->getAllCountriesAsyncWithHttpInfo($phone, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllCountriesAsyncWithHttpInfo($phone = null, string $contentType = self::contentTypes['getAllCountries'][0])
    {
        $returnType = '\EgoiClient\EgoiModel\CountryCollection';
        $request = $this->getAllCountriesRequest($phone, $contentType);
     ...
     */
    public function getAllCountriesRequest($phone = null, string $contentType = self::contentTypes['getAllCountries'][0])
    {
