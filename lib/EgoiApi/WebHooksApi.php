...
class WebHooksApi
{
     ...
     * @return \EgoiClient\EgoiModel\Webhook|\EgoiClient\EgoiModel\BadRequest|\EgoiClient\EgoiModel\Unauthorized|\EgoiClient\EgoiModel\Forbidden|\EgoiClient\EgoiModel\RequestTimeout|\EgoiClient\EgoiModel\UnprocessableEntity|\EgoiClient\EgoiModel\TooManyRequests|\EgoiClient\EgoiModel\InternalServerError|\EgoiClient\EgoiModel\ServiceUnavailable
     */
     ...
     * @throws \EgoiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EgoiClient\EgoiModel\Webhook|\EgoiClient\EgoiModel\BadRequest|\EgoiClient\EgoiModel\Unauthorized|\EgoiClient\EgoiModel\Forbidden|\EgoiClient\EgoiModel\RequestTimeout|\EgoiClient\EgoiModel\UnprocessableEntity|\EgoiClient\EgoiModel\TooManyRequests|\EgoiClient\EgoiModel\InternalServerError|\EgoiClient\EgoiModel\ServiceUnavailable, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function getAllWebhooks($offset = null, $limit = 10)
    {
        list($response) = $this->getAllWebhooksWithHttpInfo($offset, $limit);
        return $response;
    }
     ...
     */
    public function getAllWebhooksWithHttpInfo($offset = null, $limit = 10)
    {
        $request = $this->getAllWebhooksRequest($offset, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsync($offset = null, $limit = 10)
    {
        return $this->getAllWebhooksAsyncWithHttpInfo($offset, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsyncWithHttpInfo($offset = null, $limit = 10)
    {
        $returnType = '\EgoiClient\EgoiModel\ListCollection1';
        $request = $this->getAllWebhooksRequest($offset, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllWebhooksRequest($offset = null, $limit = 10)
    {
