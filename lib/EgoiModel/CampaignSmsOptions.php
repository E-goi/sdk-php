 ...
 */
class CampaignSmsOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setMaxMessages($max_messages)
    {
        ...
        if (!is_null($max_messages) && ($max_messages > 7)) {
            throw new \InvalidArgumentException('invalid value for $max_messages when calling CampaignSmsOptions., must be smaller than or equal to 7.');
        }
