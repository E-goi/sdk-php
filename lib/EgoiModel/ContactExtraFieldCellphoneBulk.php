...
/**
 * ContactExtraFieldCellphoneBulk Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class ContactExtraFieldCellphoneBulk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactExtraFieldCellphoneBulk';
    ...
    */
    ...
    public function setFieldId($field_id)
    {
        ...
        if (!is_null($field_id) && ($field_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $field_id when calling ContactExtraFieldCellphoneBulk., must be bigger than or equal to 1.');
        }
