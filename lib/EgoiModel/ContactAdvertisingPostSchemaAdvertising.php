...
/**
 * ContactAdvertisingPostSchemaAdvertising Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactAdvertisingPostSchemaAdvertising implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactAdvertisingPostSchema_advertising';
    ...
    */
     ...
     * Sets gclid
     *
     * @param string|null $gclid Identifier that Google uses in Google Ads
     *
     * @return self
     */
     ...
     * Sets msclkid
     *
     * @param string|null $msclkid Identifier that Microsoft uses in Microsoft Ads
     *
     * @return self
     */
     ...
     * Sets fbclid
     *
     * @param string|null $fbclid Identifier that Facebook uses in Facebook Ads
     *
     * @return self
     */
