...
/**
 * PushReportOperatingSystemsInner Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class PushReportOperatingSystemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushReport_operating_systems_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['received']) && ($this->container['received'] < 0)) {
            $invalidProperties[] = "invalid value for 'received', must be bigger than or equal to 0.";
        }
     ...
     *
     * @param string|null $operating_systems Device type
     *
     * @return self
     */
    ...
    public function setSends($sends)
    {
        ...
        if (!is_null($sends) && ($sends < 0)) {
            throw new \InvalidArgumentException('invalid value for $sends when calling PushReportOperatingSystemsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling PushReportOperatingSystemsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setDelivered($delivered)
    {
        ...
        if (!is_null($delivered) && ($delivered < 0)) {
            throw new \InvalidArgumentException('invalid value for $delivered when calling PushReportOperatingSystemsInner., must be bigger than or equal to 0.');
        }
     ...
     * Sets received
     *
     * @param int|null $received Total number of received messages
     *
     * @return self
     */
    public function setReceived($received)
    {
        ...
        if (!is_null($received) && ($received < 0)) {
            throw new \InvalidArgumentException('invalid value for $received when calling PushReportOperatingSystemsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setBounces($bounces)
    {
        ...
        if (!is_null($bounces) && ($bounces < 0)) {
            throw new \InvalidArgumentException('invalid value for $bounces when calling PushReportOperatingSystemsInner., must be bigger than or equal to 0.');
        }
     ...
     * Sets error
     *
     * @param int|null $error Total number of error messages
     *
     * @return self
     */
    public function setError($error)
    {
        ...
        if (!is_null($error) && ($error < 0)) {
            throw new \InvalidArgumentException('invalid value for $error when calling PushReportOperatingSystemsInner., must be bigger than or equal to 0.');
        }
