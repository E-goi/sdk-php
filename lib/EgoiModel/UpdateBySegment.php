...
/**
 * UpdateBySegment Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateBySegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Update_by_Segment';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Updates contacts in the selected segment (excluding removed contacts)
     *
     * @return self
     */
