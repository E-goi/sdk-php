...
/**
 * SuppressionTypeEmail Class Doc Comment
 *
 * @category Class
 ...
 */
class SuppressionTypeEmail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuppressionTypeEmail';
    ...
    */
     ...
     * Sets value
     *
     * @param string[] $value Array of email values to add to the suppression list
     *
     * @return self
     */
