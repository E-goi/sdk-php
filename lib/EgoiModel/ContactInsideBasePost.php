    ...
    */
    ...
    public function setCellphone($cellphone)
    {
        ...
        if (!is_null($cellphone) && (!preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $cellphone))) {
            throw new \InvalidArgumentException("invalid value for \$cellphone when calling ContactInsideBasePost., must conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.");
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $phone))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling ContactInsideBasePost., must conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.");
        }
