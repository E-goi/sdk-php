 ...
 */
class PushEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('message_hash', $data ?? [], null);
        $this->setIfExists('mailing_id', $data ?? [], null);
    ...
    */
    ...
    public function setMessageHash($message_hash)
    {
        ...
        if (is_null($message_hash)) {
            throw new \InvalidArgumentException('non-nullable message_hash cannot be null');
        }
     ...
     * Sets mailing_id
     *
     * @param int|null $mailing_id The id of the campaign operation related to the notification.
     *
     * @return self
     */
    public function setMailingId($mailing_id)
    {
        ...
        if (is_null($mailing_id)) {
            throw new \InvalidArgumentException('non-nullable mailing_id cannot be null');
        }
