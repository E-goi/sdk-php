 ...
 */
class RemoveResponseErrors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'invalid_unsubscription_reason' => false,
		'invalid_unsubscription_method' => false,
		'invalid_data_type' => false,
		'contact_not_in_list' => false,
		'contact_already_removed' => false
    ];
    ...
    {
        $this->setIfExists('invalid_unsubscription_reason', $data ?? [], null);
        $this->setIfExists('invalid_unsubscription_method', $data ?? [], null);
        $this->setIfExists('invalid_data_type', $data ?? [], null);
        $this->setIfExists('contact_not_in_list', $data ?? [], null);
        $this->setIfExists('contact_already_removed', $data ?? [], null);
    }
    ...
    */
    ...
    public function setInvalidUnsubscriptionReason($invalid_unsubscription_reason)
    {
        ...
        if (is_null($invalid_unsubscription_reason)) {
            throw new \InvalidArgumentException('non-nullable invalid_unsubscription_reason cannot be null');
        }
    ...
    public function setInvalidUnsubscriptionMethod($invalid_unsubscription_method)
    {
        ...
        if (is_null($invalid_unsubscription_method)) {
            throw new \InvalidArgumentException('non-nullable invalid_unsubscription_method cannot be null');
        }
    ...
    public function setInvalidDataType($invalid_data_type)
    {
        ...
        if (is_null($invalid_data_type)) {
            throw new \InvalidArgumentException('non-nullable invalid_data_type cannot be null');
        }
    ...
    public function setContactNotInList($contact_not_in_list)
    {
        ...
        if (is_null($contact_not_in_list)) {
            throw new \InvalidArgumentException('non-nullable contact_not_in_list cannot be null');
        }
    ...
    public function setContactAlreadyRemoved($contact_already_removed)
    {
        ...
        if (is_null($contact_already_removed)) {
            throw new \InvalidArgumentException('non-nullable contact_already_removed cannot be null');
        }
