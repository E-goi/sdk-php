...
/**
 * ContactBaseWithStatusNoRemovedFieldsSchemaBase Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactBaseWithStatusNoRemovedFieldsSchemaBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactBaseWithStatusNoRemovedFieldsSchema_base';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cellphone']) && !preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $this->container['cellphone'])) {
            $invalidProperties[] = "invalid value for 'cellphone', must be conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.";
        }
        ...
        if (!is_null($this->container['phone']) && !preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $this->container['phone'])) {
            $invalidProperties[] = "invalid value for 'phone', must be conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.";
        }
    ...
    public function setContactId($contact_id)
    {
        ...
        if (!is_null($contact_id) && (!preg_match("/[a-fA-F\\d]{10}/", $contact_id))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling ContactBaseWithStatusNoRemovedFieldsSchemaBase., must conform to the pattern /[a-fA-F\\d]{10}/.");
        }
     ...
     * Sets cellphone
     *
     * @param string|null $cellphone Cellphone of the contact (country code followed by phone number, split by '-')
     *
     * @return self
     */
    public function setCellphone($cellphone)
    {
        ...
        if (!is_null($cellphone) && (!preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $cellphone))) {
            throw new \InvalidArgumentException("invalid value for \$cellphone when calling ContactBaseWithStatusNoRemovedFieldsSchemaBase., must conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.");
        }
     ...
     * Sets phone
     *
     * @param string|null $phone Phone of the contact (country code followed by phone number, split by '-')
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $phone))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling ContactBaseWithStatusNoRemovedFieldsSchemaBase., must conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.");
        }
