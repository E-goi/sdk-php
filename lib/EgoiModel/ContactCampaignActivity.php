...
/**
 * ContactCampaignActivity Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactCampaignActivity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactCampaignActivity';
    ...
    protected static $openAPITypes = [
        'action_data' => '\EgoiClient\EgoiModel\ContactCampaignActivityAllOfActionData',
        'date' => '\DateTime',
        'action_name' => 'string'
    ];
    ...
    public const ACTION_NAME_VOICE_MENU_EVENT = 'voice_menu_event';
    public const ACTION_NAME_VOICE_REDIRECT = 'voice_redirect';
    public const ACTION_NAME_PUSH_DELIVERED = 'push_delivered';
    public const ACTION_NAME_SMART_SMS_SEND = 'smart_sms_send';
    public const ACTION_NAME_SMART_SMS_OPEN = 'smart_sms_open';
    public const ACTION_NAME_SMART_SMS_REPORT = 'smart_sms_report';
    ...
    public function getActionNameAllowableValues()
    {
        return [
            ...
            self::ACTION_NAME_VOICE_MENU_EVENT,
            self::ACTION_NAME_VOICE_REDIRECT,
            self::ACTION_NAME_PUSH_DELIVERED,
            self::ACTION_NAME_SMART_SMS_SEND,
            self::ACTION_NAME_SMART_SMS_OPEN,
            self::ACTION_NAME_SMART_SMS_REPORT,
        ];
    }
    ...
    */
     ...
     * Gets action_data
     *
     * @return \EgoiClient\EgoiModel\ContactCampaignActivityAllOfActionData|null
     */
     ...
     * Sets action_data
     *
     * @param \EgoiClient\EgoiModel\ContactCampaignActivityAllOfActionData|null $action_data action_data
     *
     * @return self
     */
