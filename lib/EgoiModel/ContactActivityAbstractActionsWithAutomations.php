...
/**
 * ContactActivityAbstractActionsWithAutomations Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactActivityAbstractActionsWithAutomations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactActivityAbstractActionsWithAutomations';
    ...
    public const ACTION_NAME_EVENT = 'automation_event';
    public const ACTION_NAME_ACTION = 'automation_action';
    public const ACTION_NAME_TRIGGER = 'automation_trigger';
    ...
    {
        return [
            self::ACTION_NAME_EVENT,
            self::ACTION_NAME_ACTION,
            self::ACTION_NAME_TRIGGER,
        ];
    }
