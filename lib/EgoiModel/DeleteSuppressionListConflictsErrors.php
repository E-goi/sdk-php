...
/**
 * DeleteSuppressionListConflictsErrors Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSuppressionListConflictsErrors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteSuppressionListConflictsErrors';
    ...
    protected static $openAPITypes = [
        'errors' => '\EgoiClient\EgoiModel\UnremovableEntryErrors',
        'type' => 'string',
        'title' => 'string',
        'status' => 'int',
        'detail' => 'string'
    ...
    public const TITLE_CONFLICT = 'Conflict';
    ...
    */
     ...
     * Gets errors
     *
     * @return \EgoiClient\EgoiModel\UnremovableEntryErrors|null
     */
     ...
     * Sets errors
     *
     * @param \EgoiClient\EgoiModel\UnremovableEntryErrors|null $errors errors
     *
     * @return self
     */
