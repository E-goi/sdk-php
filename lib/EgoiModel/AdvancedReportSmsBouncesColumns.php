 ...
 */
class AdvancedReportSmsBouncesColumns implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'list_stats_fields' => false,
		'campaign_fields' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('list_stats_fields', $data ?? [], null);
        $this->setIfExists('campaign_fields', $data ?? [], null);
    }
    ...
    */
    ...
    public function setListStatsFields($list_stats_fields)
    {
        ...
        if (is_null($list_stats_fields)) {
            throw new \InvalidArgumentException('non-nullable list_stats_fields cannot be null');
        }
    ...
    public function setCampaignFields($campaign_fields)
    {
        ...
        if (is_null($campaign_fields)) {
            throw new \InvalidArgumentException('non-nullable campaign_fields cannot be null');
        }
