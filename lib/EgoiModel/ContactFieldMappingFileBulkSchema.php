...
/**
 * ContactFieldMappingFileBulkSchema Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class ContactFieldMappingFileBulkSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contactFieldMappingFileBulkSchema';
    ...
    */
    ...
    public function setFieldId($field_id)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9_-]*/", $field_id))) {
            throw new \InvalidArgumentException("invalid value for \$field_id when calling ContactFieldMappingFileBulkSchema., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
     ...
     * Sets column_name
     *
     * @param string $column_name The column name as defined in your file
     *
     * @return self
     */
