...
/**
 * WebPushReportOperatingSystemsInnerVersionsInner Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class WebPushReportOperatingSystemsInnerVersionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushReport_operating_systems_inner_versions_inner';
    ...
    */
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling WebPushReportOperatingSystemsInnerVersionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setSends($sends)
    {
        ...
        if (!is_null($sends) && ($sends < 0)) {
            throw new \InvalidArgumentException('invalid value for $sends when calling WebPushReportOperatingSystemsInnerVersionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setClicks($clicks)
    {
        ...
        if (!is_null($clicks) && ($clicks < 0)) {
            throw new \InvalidArgumentException('invalid value for $clicks when calling WebPushReportOperatingSystemsInnerVersionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setBounces($bounces)
    {
        ...
        if (!is_null($bounces) && ($bounces < 0)) {
            throw new \InvalidArgumentException('invalid value for $bounces when calling WebPushReportOperatingSystemsInnerVersionsInner., must be bigger than or equal to 0.');
        }
