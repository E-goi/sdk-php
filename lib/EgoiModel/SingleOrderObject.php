...
/**
 * SingleOrderObject Class Doc Comment
 *
 * @category Class
 ...
 */
class SingleOrderObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleOrderObject';
    ...
    */
     ...
     * Sets revenue
     *
     * @param float $revenue Ecommerce order revenue
     *
     * @return self
     */
    public function setRevenue($revenue)
    {
        ...
        if (($revenue < 0)) {
            throw new \InvalidArgumentException('invalid value for $revenue when calling SingleOrderObject., must be bigger than or equal to 0.');
        }
