...
/**
 * PatchVoiceCampaign200Response Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class PatchVoiceCampaign200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchVoiceCampaign_200_response';
    ...
    */
    ...
    public function setCampaignHash($campaign_hash)
    {
        ...
        if (!is_null($campaign_hash) && (!preg_match("/[a-zA-Z0-9_-]*/", $campaign_hash))) {
            throw new \InvalidArgumentException("invalid value for \$campaign_hash when calling PatchVoiceCampaign200Response., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
