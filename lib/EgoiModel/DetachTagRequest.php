...
/**
 * DetachTagRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DetachTagRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DetachTagRequest';
    ...
    */
    ...
    public function setTagId($tag_id)
    {
        ...
        if (($tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $tag_id when calling DetachTagRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets contacts
     *
     * @param string[] $contacts Array of contacts to detach the tag
     *
     * @return self
     */
    public function setContacts($contacts)
    {
        ...
        if ((count($contacts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contacts when calling DetachTagRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setFieldId($field_id)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9_-]*/", $field_id))) {
            throw new \InvalidArgumentException("invalid value for \$field_id when calling DetachTagRequest., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
