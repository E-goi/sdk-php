 ...
 */
class RequestTimeout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestTimeout';
    ...
    public const TITLE_REQUEST_TIMEOUT = 'Request Timeout';
