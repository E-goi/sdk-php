...
/**
 * PostCNameConflict Class Doc Comment
 *
 * @category Class
 ...
 */
class PostCNameConflict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostCNameConflict';
    ...
    protected static $openAPITypes = [
        'errors' => '\EgoiClient\EgoiModel\CnameExistsErrors',
        'type' => 'string',
        'title' => 'string',
        'status' => 'int',
        'detail' => 'string'
    ...
    */
     ...
     * Gets errors
     *
     * @return \EgoiClient\EgoiModel\CnameExistsErrors|null
     */
     ...
     * Sets errors
     *
     * @param \EgoiClient\EgoiModel\CnameExistsErrors|null $errors errors
     *
     * @return self
     */
