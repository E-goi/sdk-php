...
/**
 * ConnectedSitesGeneralProductFormDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectedSitesGeneralProductFormDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectedSitesGeneralProductFormDetail';
    ...
    */
    ...
    public function setFormId($form_id)
    {
        ...
        if (!is_null($form_id) && ($form_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $form_id when calling ConnectedSitesGeneralProductFormDetail., must be bigger than or equal to 1.');
        }
