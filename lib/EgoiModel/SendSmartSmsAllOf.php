...
/**
 * SendSmartSmsAllOf Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class SendSmartSmsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendSmartSms_allOf';
    ...
    */
    ...
    public function setListId($list_id)
    {
        ...
        if (!is_null($list_id) && ($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling SendSmartSmsAllOf., must be bigger than or equal to 1.');
        }
