...
/**
 * PushVersionsVersionsInner Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class PushVersionsVersionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushVersions_versions_inner';
    ...
    */
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling PushVersionsVersionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setCanceled($canceled)
    {
        ...
        if (!is_null($canceled) && ($canceled < 0)) {
            throw new \InvalidArgumentException('invalid value for $canceled when calling PushVersionsVersionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setDelivered($delivered)
    {
        ...
        if (!is_null($delivered) && ($delivered < 0)) {
            throw new \InvalidArgumentException('invalid value for $delivered when calling PushVersionsVersionsInner., must be bigger than or equal to 0.');
        }
