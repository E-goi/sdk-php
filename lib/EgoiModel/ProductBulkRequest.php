 ...
 */
class ProductBulkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('mode', $data ?? [], 'update');
    }
    ...
    */
     ...
     * Gets products
     *
     * @return \EgoiClient\EgoiModel\Product[]
     */
     ...
     * Sets products
     *
     * @param \EgoiClient\EgoiModel\Product[] $products Collection of products to import. Products having an incorrect format will be ignored
     *
     * @return self
     */
