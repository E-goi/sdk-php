...
/**
 * ContactTagActivity Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactTagActivity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactTagActivity';
    ...
    protected static $openAPITypes = [
        'action_data' => '\EgoiClient\EgoiModel\ContactTagActivityAllOfActionData',
        'date' => '\DateTime',
        'action_name' => 'string'
    ];
    ...
    public const ACTION_NAME_ATTACH_TAG = 'attach_tag';
    public const ACTION_NAME_DETACH_TAG = 'detach_tag';
    ...
    {
        return [
            self::ACTION_NAME_ATTACH_TAG,
            self::ACTION_NAME_DETACH_TAG,
        ];
    }
    ...
    */
     ...
     * Gets action_data
     *
     * @return \EgoiClient\EgoiModel\ContactTagActivityAllOfActionData|null
     */
     ...
     * Sets action_data
     *
     * @param \EgoiClient\EgoiModel\ContactTagActivityAllOfActionData|null $action_data action_data
     *
     * @return self
     */
