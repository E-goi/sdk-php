...
/**
 * ContactsActionUpdateContactsSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactsActionUpdateContactsSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactsActionUpdateContactsSchema';
    ...
    */
    ...
    public function setContacts($contacts)
    {
        ...
        if ((count($contacts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contacts when calling ContactsActionUpdateContactsSchema., number of items must be greater than or equal to 1.');
        }
