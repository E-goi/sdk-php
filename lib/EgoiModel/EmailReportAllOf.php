...
/**
 * EmailReportAllOf Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class EmailReportAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailReport_allOf';
    ...
    */
    ...
    public function setCampaignHash($campaign_hash)
    {
        ...
        if (!is_null($campaign_hash) && (!preg_match("/[a-zA-Z0-9_-]*/", $campaign_hash))) {
            throw new \InvalidArgumentException("invalid value for \$campaign_hash when calling EmailReportAllOf., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
