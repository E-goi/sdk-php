 ...
 */
class SendPush implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setAppId($app_id)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9_-]*/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for \$app_id when calling SendPush., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
