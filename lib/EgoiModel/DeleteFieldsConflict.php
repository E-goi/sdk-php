 ...
 */
class DeleteFieldsConflict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\EgoiClient\EgoiModel\FieldInUseErrors',
        'type' => 'string',
        'title' => 'string',
        'status' => 'int',
        'detail' => 'string'
    ...
    */
     ...
     * Gets errors
     *
     * @return \EgoiClient\EgoiModel\FieldInUseErrors|null
     */
     ...
     * Sets errors
     *
     * @param \EgoiClient\EgoiModel\FieldInUseErrors|null $errors errors
     *
     * @return self
     */
