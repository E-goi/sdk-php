 ...
 */
class NumericCellphoneSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCellphone($cellphone)
    {
        ...
        if ((!preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $cellphone))) {
            throw new \InvalidArgumentException("invalid value for \$cellphone when calling NumericCellphoneSender., must conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.");
        }
