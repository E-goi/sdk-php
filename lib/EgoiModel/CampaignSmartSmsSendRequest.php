...
/**
 * CampaignSmartSmsSendRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CampaignSmartSmsSendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignSmartSmsSendRequest';
    ...
    */
    ...
    public function setListId($list_id)
    {
        ...
        if (($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling CampaignSmartSmsSendRequest., must be bigger than or equal to 1.');
        }
