 ...
 */
class AttachTagRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/[a-zA-Z0-9_-]*/", $this->container['field_id'])) {
            $invalidProperties[] = "invalid value for 'field_id', must be conform to the pattern /[a-zA-Z0-9_-]*/.";
        }
     ...
     * Sets contacts
     *
     * @param string[] $contacts Array of contacts to attach the tag
     *
     * @return self
     */
    public function setContacts($contacts)
    {
        ...
        if ((count($contacts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contacts when calling AttachTagRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setFieldId($field_id)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9_-]*/", $field_id))) {
            throw new \InvalidArgumentException("invalid value for \$field_id when calling AttachTagRequest., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
