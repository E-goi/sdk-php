 ...
 */
class ContactActivityAbstractActionsWithData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ACTION_NAME_EMAIL_CLICK = 'email_click';
    public const ACTION_NAME_PUSH_CLICK = 'push_click';
    public const ACTION_NAME_WEB_PUSH_CLICK = 'web_push_click';
    public const ACTION_NAME_SMART_SMS_CLICK = 'smart_sms_click';
    ...
    public function getActionNameAllowableValues()
    {
        return [
            ...
            self::ACTION_NAME_SMART_SMS_CLICK,
        ];
    }
