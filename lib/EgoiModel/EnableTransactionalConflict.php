...
/**
 * EnableTransactionalConflict Class Doc Comment
 *
 * @category Class
 ...
 */
class EnableTransactionalConflict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnableTransactionalConflict';
    ...
    protected static $openAPITypes = [
        'errors' => '\EgoiClient\EgoiModel\ClientIsBeingEnabledErrors',
        'type' => 'string',
        'title' => 'string',
        'status' => 'int',
        'detail' => 'string'
    ...
    */
     ...
     * Gets errors
     *
     * @return \EgoiClient\EgoiModel\ClientIsBeingEnabledErrors|null
     */
     ...
     * Sets errors
     *
     * @param \EgoiClient\EgoiModel\ClientIsBeingEnabledErrors|null $errors errors
     *
     * @return self
     */
