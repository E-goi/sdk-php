...
/**
 * ConnectedSitesGeneralProductAppDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectedSitesGeneralProductAppDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectedSitesGeneralProductAppDetail';
    ...
    */
    ...
    public function setSiteId($site_id)
    {
        ...
        if (!is_null($site_id) && ($site_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $site_id when calling ConnectedSitesGeneralProductAppDetail., must be bigger than or equal to 1.');
        }
