...
/**
 * PostWebpushSiteConflict Class Doc Comment
 *
 * @category Class
 ...
 */
class PostWebpushSiteConflict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostWebpushSiteConflict';
    ...
    protected static $openAPITypes = [
        'errors' => '\EgoiClient\EgoiModel\NameAlreadyExistsErrors',
        'type' => 'string',
        'title' => 'string',
        'status' => 'int',
        'detail' => 'string'
    ...
    */
     ...
     * Gets errors
     *
     * @return \EgoiClient\EgoiModel\NameAlreadyExistsErrors|null
     */
     ...
     * Sets errors
     *
     * @param \EgoiClient\EgoiModel\NameAlreadyExistsErrors|null $errors errors
     *
     * @return self
     */
