 ...
 */
class VoicePatchCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setGroupId($group_id)
    {
        ...
        if (!is_null($group_id) && ($group_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $group_id when calling VoicePatchCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setSenderId($sender_id)
    {
        ...
        if (!is_null($sender_id) && ($sender_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $sender_id when calling VoicePatchCampaign., must be bigger than or equal to 1.');
        }
