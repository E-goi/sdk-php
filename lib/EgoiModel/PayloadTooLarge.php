...
/**
 * PayloadTooLarge Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class PayloadTooLarge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayloadTooLarge';
    ...
    public const TITLE_PAYLOAD_TOO_LARGE = 'Payload Too Large';
