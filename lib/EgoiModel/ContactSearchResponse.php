 ...
 */
class ContactSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactSearchResponse';
    ...
    */
    ...
    public function setContactId($contact_id)
    {
        ...
        if (!is_null($contact_id) && (!preg_match("/[a-fA-F\\d]{10}/", $contact_id))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling ContactSearchResponse., must conform to the pattern /[a-fA-F\\d]{10}/.");
        }
    ...
    public function setListId($list_id)
    {
        ...
        if (!is_null($list_id) && ($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling ContactSearchResponse., must be bigger than or equal to 1.');
        }
