...
/**
 * ContactStatsPushStats Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactStatsPushStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactStats_push_stats';
    ...
    */
    ...
    public function setLastViewDate($last_view_date)
    {
        ...
        if (is_null($last_view_date)) {
            array_push($this->openAPINullablesSetToNull, 'last_view_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_view_date', $nullablesSetToNull);
            if ($index !== FALSE) {
