...
/**
 * AdvancedReportFormsInner Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class AdvancedReportFormsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdvancedReportForms_inner';
    ...
    */
    ...
    public function setListId($list_id)
    {
        ...
        if (!is_null($list_id) && ($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling AdvancedReportFormsInner., must be bigger than or equal to 1.');
        }
     ...
     * Sets forms
     *
     * @param int[]|null $forms Array of form IDs
     *
     * @return self
     */
