 ...
 */
class PostListsConflict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\EgoiClient\EgoiModel\ListLimitReachedErrors',
        'type' => 'string',
        'title' => 'string',
        'status' => 'int',
        'detail' => 'string'
    ...
    */
     ...
     * Gets errors
     *
     * @return \EgoiClient\EgoiModel\ListLimitReachedErrors|null
     */
     ...
     * Sets errors
     *
     * @param \EgoiClient\EgoiModel\ListLimitReachedErrors|null $errors errors
     *
     * @return self
     */
