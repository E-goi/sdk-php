...
/**
 * SendSmartSms Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class SendSmartSms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendSmartSms';
    ...
    */
    ...
    public function setListId($list_id)
    {
        ...
        if (($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling SendSmartSms., must be bigger than or equal to 1.');
        }
