...
/**
 * ContactAutomationsActivityAllOfActionData Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactAutomationsActivityAllOfActionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactAutomationsActivity_allOf_action_data';
    ...
    */
    ...
    public function setAutomationId($automation_id)
    {
        ...
        if (!is_null($automation_id) && ($automation_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $automation_id when calling ContactAutomationsActivityAllOfActionData., must be bigger than or equal to 1.');
        }
