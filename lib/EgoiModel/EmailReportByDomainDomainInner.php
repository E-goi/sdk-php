...
/**
 * EmailReportByDomainDomainInner Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class EmailReportByDomainDomainInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailReportByDomain_domain_inner';
    ...
    */
    ...
    public function setSends($sends)
    {
        ...
        if (!is_null($sends) && ($sends < 0)) {
            throw new \InvalidArgumentException('invalid value for $sends when calling EmailReportByDomainDomainInner., must be bigger than or equal to 0.');
        }
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling EmailReportByDomainDomainInner., must be bigger than or equal to 0.');
        }
    ...
    public function setClicks($clicks)
    {
        ...
        if (!is_null($clicks) && ($clicks < 0)) {
            throw new \InvalidArgumentException('invalid value for $clicks when calling EmailReportByDomainDomainInner., must be bigger than or equal to 0.');
        }
    ...
    public function setHardBounces($hard_bounces)
    {
        ...
        if (!is_null($hard_bounces) && ($hard_bounces < 0)) {
            throw new \InvalidArgumentException('invalid value for $hard_bounces when calling EmailReportByDomainDomainInner., must be bigger than or equal to 0.');
        }
    ...
    public function setSoftBounces($soft_bounces)
    {
        ...
        if (!is_null($soft_bounces) && ($soft_bounces < 0)) {
            throw new \InvalidArgumentException('invalid value for $soft_bounces when calling EmailReportByDomainDomainInner., must be bigger than or equal to 0.');
        }
    ...
    public function setComplaints($complaints)
    {
        ...
        if (!is_null($complaints) && ($complaints < 0)) {
            throw new \InvalidArgumentException('invalid value for $complaints when calling EmailReportByDomainDomainInner., must be bigger than or equal to 0.');
        }
    ...
    public function setUnsubscriptions($unsubscriptions)
    {
        ...
        if (!is_null($unsubscriptions) && ($unsubscriptions < 0)) {
            throw new \InvalidArgumentException('invalid value for $unsubscriptions when calling EmailReportByDomainDomainInner., must be bigger than or equal to 0.');
        }
