...
/**
 * AutomationActionsAllOf Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class AutomationActionsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutomationActions_allOf';
    ...
    */
    ...
    public function setActionId($action_id)
    {
        ...
        if (!is_null($action_id) && ($action_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $action_id when calling AutomationActionsAllOf., must be bigger than or equal to 1.');
        }
     ...
     * Sets action
     *
     * @param string|null $action Type od action
     *
     * @return self
     */
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && ($parent_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $parent_id when calling AutomationActionsAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setCreatedBy($created_by)
    {
        ...
        if (!is_null($created_by) && ($created_by < 1)) {
            throw new \InvalidArgumentException('invalid value for $created_by when calling AutomationActionsAllOf., must be bigger than or equal to 1.');
        }
