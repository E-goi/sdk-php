 ...
 */
class PushStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushStats';
    ...
    */
    ...
    public function setSends($sends)
    {
        ...
        if (!is_null($sends) && ($sends < 0)) {
            throw new \InvalidArgumentException('invalid value for $sends when calling PushStats., must be bigger than or equal to 0.');
        }
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling PushStats., must be bigger than or equal to 0.');
        }
    ...
    public function setDelivered($delivered)
    {
        ...
        if (!is_null($delivered) && ($delivered < 0)) {
            throw new \InvalidArgumentException('invalid value for $delivered when calling PushStats., must be bigger than or equal to 0.');
        }
    ...
    public function setReceived($received)
    {
        ...
        if (!is_null($received) && ($received < 0)) {
            throw new \InvalidArgumentException('invalid value for $received when calling PushStats., must be bigger than or equal to 0.');
        }
    ...
    public function setBounces($bounces)
    {
        ...
        if (!is_null($bounces) && ($bounces < 0)) {
            throw new \InvalidArgumentException('invalid value for $bounces when calling PushStats., must be bigger than or equal to 0.');
        }
    ...
    public function setError($error)
    {
        ...
        if (!is_null($error) && ($error < 0)) {
            throw new \InvalidArgumentException('invalid value for $error when calling PushStats., must be bigger than or equal to 0.');
        }
