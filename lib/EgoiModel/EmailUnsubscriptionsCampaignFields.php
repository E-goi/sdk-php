 ...
 */
class EmailUnsubscriptionsCampaignFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets send_date
     *
     * @param bool|null $send_date True to include the send date of the campaign, false otherwise
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param bool|null $group True to include the group of the campaign, false otherwise
     *
     * @return self
     */
