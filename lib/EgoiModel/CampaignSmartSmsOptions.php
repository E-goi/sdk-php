...
class CampaignSmartSmsOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['max_messages']) && ($this->container['max_messages'] > 9)) {
            $invalidProperties[] = "invalid value for 'max_messages', must be smaller than or equal to 9.";
        }
    ...
    public function setMaxMessages($max_messages)
    {
        ...
        if (!is_null($max_messages) && ($max_messages > 9)) {
            throw new \InvalidArgumentException('invalid value for $max_messages when calling CampaignSmartSmsOptions., must be smaller than or equal to 9.');
        }
