...
/**
 * CampaignSmartSmsOptions Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class CampaignSmartSmsOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignSmartSmsOptions';
    ...
    public const ENCODING_GSM_EXTENDED = 'gsm_extended';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['max_messages']) && ($this->container['max_messages'] > 7)) {
            $invalidProperties[] = "invalid value for 'max_messages', must be smaller than or equal to 7.";
        }
    ...
    public function setMaxMessages($max_messages)
    {
        ...
        if (!is_null($max_messages) && ($max_messages > 7)) {
            throw new \InvalidArgumentException('invalid value for $max_messages when calling CampaignSmartSmsOptions., must be smaller than or equal to 7.');
        }
        if (!is_null($max_messages) && ($max_messages < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_messages when calling CampaignSmartSmsOptions., must be bigger than or equal to 1.');
        }
