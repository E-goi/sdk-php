...
/**
 * RequestEntityTooLarge Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class RequestEntityTooLarge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestEntityTooLarge';
    ...
    public const TITLE_REQUEST_ENTITY_TOO_LARGE = 'Request Entity Too Large';
    ...
    {
        return [
            self::TITLE_REQUEST_ENTITY_TOO_LARGE,
        ];
    }
