...
/**
 * ImportBulkFileRequestSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ImportBulkFileRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportBulkFileRequestSchema';
    ...
    */
     ...
     * Sets mode
     *
     * @param string $mode Add new contacts only ('add'), add and replace existing ones ('update') or only replace existing ones ('update_only')
     *
     * @return self
     */
     ...
     * Sets compare_field
     *
     * @param string $compare_field Field ID which will be mapped for comparison to prevent duplicates. Field must be set as unique in E-goi.
     *
     * @return self
     */
