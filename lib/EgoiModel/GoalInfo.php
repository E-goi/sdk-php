 ...
 * @link     https://openapi-generator.tech
 */
class GoalInfo implements ModelInterface, ArrayAccess
{
    ...
    const RULE_DOWNLOAD = 'download';
    const RULE_EXTERNAL_URL = 'external_url';
    const CONDITION_CONTAINS = 'contains';
    const CONDITION_EXACTLY = 'exactly';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['multiple_conversion'] = isset($data['multiple_conversion']) ? $data['multiple_conversion'] : null;
     ...
     * Sets minutes
     *
     * @param double|null $minutes Goal trigger time in minutes
     *
     * @return $this
     */
