...
class CreateOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets order_total
     *
     * @param float|null $order_total Ecommerce cart total
     *
     * @return self
     */
     ...
     * Sets order_id
     *
     * @param string $order_id Order ID is any non-empty unique string
     *
     * @return self
     */
     ...
     * Sets cart_id
     *
     * @param string|null $cart_id Cart ID that originated this order
     *
     * @return self
     */
