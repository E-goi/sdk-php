...
/**
 * SavedSegmentAllOf1SegmentFilter Class Doc Comment
 *
 * @category Class
 ...
 */
class SavedSegmentAllOf1SegmentFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SavedSegment_allOf_1_segment_filter';
    ...
    protected static $openAPITypes = [
        'segment_filter_array' => '\EgoiClient\EgoiModel\SavedSegmentAllOf1SegmentFilterSegmentFilterArray[]',
    ...
    public const BOOLEAN_OPERATOR__AND = 'and';
    public const BOOLEAN_OPERATOR__OR = 'or';
    ...
    {
        $this->setIfExists('segment_filter_array', $data ?? [], null);
        $this->setIfExists('boolean_operator', $data ?? [], 'and');
        $this->setIfExists('invert', $data ?? [], false);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['boolean_operator']) && !in_array($this->container['boolean_operator'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'boolean_operator', must be one of '%s'",
                $this->container['boolean_operator'],
     ...
     *
     * @return \EgoiClient\EgoiModel\SavedSegmentAllOf1SegmentFilterSegmentFilterArray[]|null
     */
     ...
     *
     * @param \EgoiClient\EgoiModel\SavedSegmentAllOf1SegmentFilterSegmentFilterArray[]|null $segment_filter_array Array of filters
     *
     * @return self
     */
    public function setSegmentFilterArray($segment_filter_array)
    {
        ...
        if (is_null($segment_filter_array)) {
            throw new \InvalidArgumentException('non-nullable segment_filter_array cannot be null');
        }
    ...
    public function setBooleanOperator($boolean_operator)
    {
        ...
        if (is_null($boolean_operator)) {
            throw new \InvalidArgumentException('non-nullable boolean_operator cannot be null');
        }
    ...
    public function setInvert($invert)
    {
        ...
        if (is_null($invert)) {
            throw new \InvalidArgumentException('non-nullable invert cannot be null');
        }
