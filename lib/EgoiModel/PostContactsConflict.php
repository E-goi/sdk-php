 ...
 */
class PostContactsConflict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\EgoiClient\EgoiModel\UniqueFieldInUseErrors',
        'type' => 'string',
        'title' => 'string',
        'status' => 'int',
        'detail' => 'string'
    ...
    */
     ...
     * Gets errors
     *
     * @return \EgoiClient\EgoiModel\UniqueFieldInUseErrors|null
     */
     ...
     * Sets errors
     *
     * @param \EgoiClient\EgoiModel\UniqueFieldInUseErrors|null $errors errors
     *
     * @return self
     */
