...
/**
 * AppStructureList Class Doc Comment
 *
 * @category Class
 ...
 */
class AppStructureList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppStructure_list';
    ...
    */
     ...
     * Sets internal_name
     *
     * @param string|null $internal_name The internal name of the list.
     *
     * @return self
     */
