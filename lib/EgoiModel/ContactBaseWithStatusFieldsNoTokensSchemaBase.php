...
/**
 * ContactBaseWithStatusFieldsNoTokensSchemaBase Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactBaseWithStatusFieldsNoTokensSchemaBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactBaseWithStatusFieldsNoTokensSchema_base';
    ...
    */
    ...
    public function setContactId($contact_id)
    {
        ...
        if (!is_null($contact_id) && (!preg_match("/[a-fA-F\\d]{10}/", $contact_id))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling ContactBaseWithStatusFieldsNoTokensSchemaBase., must conform to the pattern /[a-fA-F\\d]{10}/.");
        }
    ...
    public function setCellphone($cellphone)
    {
        ...
        if (!is_null($cellphone) && (!preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $cellphone))) {
            throw new \InvalidArgumentException("invalid value for \$cellphone when calling ContactBaseWithStatusFieldsNoTokensSchemaBase., must conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.");
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^(\\d){1,3}-(\\d){4,20}$/", $phone))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling ContactBaseWithStatusFieldsNoTokensSchemaBase., must conform to the pattern /^(\\d){1,3}-(\\d){4,20}$/.");
        }
