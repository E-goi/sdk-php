...
/**
 * WebPushReportUrlInner Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class WebPushReportUrlInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushReport_url_inner';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Url information
     *
     * @return self
     */
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling WebPushReportUrlInner., must be bigger than or equal to 0.');
        }
    ...
    public function setSends($sends)
    {
        ...
        if (!is_null($sends) && ($sends < 0)) {
            throw new \InvalidArgumentException('invalid value for $sends when calling WebPushReportUrlInner., must be bigger than or equal to 0.');
        }
    ...
    public function setClicks($clicks)
    {
        ...
        if (!is_null($clicks) && ($clicks < 0)) {
            throw new \InvalidArgumentException('invalid value for $clicks when calling WebPushReportUrlInner., must be bigger than or equal to 0.');
        }
    ...
    public function setBounces($bounces)
    {
        ...
        if (!is_null($bounces) && ($bounces < 0)) {
            throw new \InvalidArgumentException('invalid value for $bounces when calling WebPushReportUrlInner., must be bigger than or equal to 0.');
        }
