...
/**
 * SendSmartSmsAllOf1 Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class SendSmartSmsAllOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendSmartSms_allOf_1';
    ...
    */
     ...
     *
     * @param string|null $destination_field Smart SMS campaign destination field. Must be 'cellphone' or the other field ID of type                                 cellphone
     *
     * @return self
     */
