...
/**
 * SingleCartObject Class Doc Comment
 *
 * @category Class
 ...
 */
class SingleCartObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleCartObject';
    ...
    */
     ...
     * Sets revenue
     *
     * @param float $revenue Ecommerce cart revenue
     *
     * @return self
     */
    public function setRevenue($revenue)
    {
        ...
        if (($revenue < 0)) {
            throw new \InvalidArgumentException('invalid value for $revenue when calling SingleCartObject., must be bigger than or equal to 0.');
        }
     ...
     * Sets items
     *
     * @param \EgoiClient\EgoiModel\ImportOrdersBulkBulkRequestItems[] $items Array of cart's products
     *
     * @return self
     */
