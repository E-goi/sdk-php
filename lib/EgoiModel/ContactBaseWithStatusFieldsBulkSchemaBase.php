...
/**
 * ContactBaseWithStatusFieldsBulkSchemaBase Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactBaseWithStatusFieldsBulkSchemaBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactBaseWithStatusFieldsBulkSchema_base';
    ...
    */
    ...
    public function setContactId($contact_id)
    {
        ...
        if (!is_null($contact_id) && (!preg_match("/[a-fA-F\\d]{10}/", $contact_id))) {
            throw new \InvalidArgumentException("invalid value for \$contact_id when calling ContactBaseWithStatusFieldsBulkSchemaBase., must conform to the pattern /[a-fA-F\\d]{10}/.");
        }
