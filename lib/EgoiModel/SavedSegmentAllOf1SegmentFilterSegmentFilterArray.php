...
/**
 * SavedSegmentAllOf1SegmentFilterSegmentFilterArray Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class SavedSegmentAllOf1SegmentFilterSegmentFilterArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SavedSegment_allOf_1_segment_filter_segment_filter_array';
    ...
    public const SEGMENT_OPERATOR_EQUAL_TO = 'equal_to';
    public const SEGMENT_OPERATOR_NOT_EQUAL_TO = 'not_equal_to';
    public const SEGMENT_OPERATOR_GREATER_OR_EQUAL_TO = 'greater_or_equal_to';
    public const SEGMENT_OPERATOR_GREATER_THAN = 'greater_than';
    public const SEGMENT_OPERATOR_LESS_OR_EQUAL_TO = 'less_or_equal_to';
    public const SEGMENT_OPERATOR_LESS_THAN = 'less_than';
    public const SEGMENT_OPERATOR_CONTAINS = 'contains';
    public const SEGMENT_OPERATOR_DOES_NOT_CONTAIN = 'does_not_contain';
    public const SEGMENT_OPERATOR_BEGINS_WITH = 'begins_with';
    public const SEGMENT_OPERATOR_ENDS_WITH = 'ends_with';
    public const SEGMENT_OPERATOR_DATE_RANGE = 'date_range';
    ...
    {
        $this->setIfExists('segment_field', $data ?? [], null);
        $this->setIfExists('segment_operator', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['segment_operator']) && !in_array($this->container['segment_operator'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'segment_operator', must be one of '%s'",
                $this->container['segment_operator'],
    ...
    public function setSegmentField($segment_field)
    {
        ...
        if (is_null($segment_field)) {
            throw new \InvalidArgumentException('non-nullable segment_field cannot be null');
        }
    ...
    public function setSegmentOperator($segment_operator)
    {
        ...
        if (is_null($segment_operator)) {
            throw new \InvalidArgumentException('non-nullable segment_operator cannot be null');
        }
