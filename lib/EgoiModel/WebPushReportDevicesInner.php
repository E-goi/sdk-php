...
/**
 * WebPushReportDevicesInner Class Doc Comment
 *
 * @category Class
 * @package  EgoiClient
 * @author   OpenAPI Generator team
 ...
 */
class WebPushReportDevicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushReport_devices_inner';
    ...
    */
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling WebPushReportDevicesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setSends($sends)
    {
        ...
        if (!is_null($sends) && ($sends < 0)) {
            throw new \InvalidArgumentException('invalid value for $sends when calling WebPushReportDevicesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setClicks($clicks)
    {
        ...
        if (!is_null($clicks) && ($clicks < 0)) {
            throw new \InvalidArgumentException('invalid value for $clicks when calling WebPushReportDevicesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setBounces($bounces)
    {
        ...
        if (!is_null($bounces) && ($bounces < 0)) {
            throw new \InvalidArgumentException('invalid value for $bounces when calling WebPushReportDevicesInner., must be bigger than or equal to 0.');
        }
